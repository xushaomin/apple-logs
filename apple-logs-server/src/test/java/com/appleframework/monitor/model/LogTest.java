...
public class LogTest {
    ...
    public void test_to_str() throws Exception {
        ...
        Assert.assertEquals("2012-07-08 00:00:11 INFO [com.appleframework.monitor.model.Log] - buy a ticket for <Bolt>", log.toString());

        log.setIp("172.16.3.16");
        log.setPid("7721@root");
        Assert.assertEquals("2012-07-08 00:00:11 7721@root 172.16.3.16 INFO [com.appleframework.monitor.model.Log] - buy a ticket for <Bolt>", log.toString());
