...
public class ProjectAction {
    ...
    public @ResponseBody ModelMap showProject(ModelMap map, @PathVariable String name,HttpServletRequest request) throws IOException {
    ...
    public @ResponseBody WebResult updateBasic(@PathVariable String name, HttpEntity<Project> entity) throws IOException {
        Project project = entity.getBody();
    ...
    public @ResponseBody WebResult updateNotify(@PathVariable String name, HttpServletRequest request, HttpEntity<Map> httpEntity) throws IOException {
